...
I haven't done much to make the page nice on a vertical layout so I'm sorry if things are hard or impossible to navigate 
on a phone. 
...
- This site is currently being hosted on an old office pc behind an nginx proxy, but I plan to move it onto a raspberry pi 
because I have like 3 sitting around at this point.
- All the code is on [github](https://github.com/kekley/blogsauce) if you want to see the heinous crimes I committed because I wanted to get everything done this week.  
